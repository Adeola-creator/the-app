...
function Navbar (){
    return <nav className="flex justify-between item-center w-full sticky top-0 px-10 py-5">
        ...
        <ul className="flex">
            ...
            <li className="m-4 px-5"><a className="duration-300 hover:opacity-50 text-bold text-lg" href="/stock">Stock</a></li>
            <li className="m-4 px-5"><a className="duration-300 hover:opacity-50 text-bold text-lg" href="/visits">Visits</a></li> 
        </ul>
    </nav>
}
